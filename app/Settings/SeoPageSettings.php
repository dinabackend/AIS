...
class SeoPageSettings extends Settings
{
    ...
    public ?string $events_title_uz;
    public ?string $events_description_uz;
    public ?string $events_img;
    public ?string $events_title_ru;
    public ?string $events_description_ru;
    ...
    public ?string $guaranty_title_uz;
    public ?string $guaranty_description_uz;
    public ?string $guaranty_img;
    public ?string $guaranty_title_ru;
    public ?string $guaranty_description_ru;
    public ?string $guaranty_title_en;
    public ?string $guaranty_description_en;


    public ?string $parts_title_uz;
    public ?string $parts_description_uz;
    public ?string $parts_img;
    public ?string $parts_title_ru;
    public ?string $parts_description_ru;
    public ?string $parts_title_en;
    public ?string $parts_description_en;


    public ?string $rent_title_uz;
    public ?string $rent_description_uz;
    public ?string $rent_img;
    public ?string $rent_title_ru;
    public ?string $rent_description_ru;
    public ?string $rent_title_en;
    public ?string $rent_description_en;


    public ?string $engineering_title_uz;
    public ?string $engineering_description_uz;
    public ?string $engineering_img;
    public ?string $engineering_title_ru;
    public ?string $engineering_description_ru;
    public ?string $engineering_title_en;
    public ?string $engineering_description_en;
